...
//        Jdbc.creer("oracle.jdbc.driver.OracleDriver", "jdbc:oracle:thin:", "@localhost:1521:XE", "", "btssio", "btssio");
     ...
     * @throws SQLException
     */
    public static void test3_VendreRepresentation(int id,int nbDePlace) throws SQLException {
        int placesVendues = RepresentationDao.vendreRepresentation(id, nbDePlace);
        System.out.println("Representation d'identifiant : "+ id +" \nNombre de places vendue(s): "+ nbDePlace);
    }
}